...
import {parseDateQuery} from './journal-search.js';
import {
	loadJournalEntryByPath,
	replaceJournalEntryByPath,
} from './journal-store.js';
import {openJournalInEditor} from './journal-editor.js';
import {getJournalLocation} from './journal-paths.js';
...
export const openJournalEntryForDate = async ({
	...
	const parsedDate = parseDateQuery(dateText, now);
	if (!parsedDate) {
